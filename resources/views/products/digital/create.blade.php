...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add Digital Product') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('digital-products.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="price" class="col-md-4 col-form-label text-md-right">{{ __('Screen size') }}</label>

                            <div class="col-md-6">
                                <input id="screen_size" type="text" class="form-control @error('screen_size') is-invalid @enderror" name="screen_size" value="{{ old('screen_size') }}" required autocomplete="screen_size" autofocus>
